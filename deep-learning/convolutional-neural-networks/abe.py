...
def prediction_model(images):
  ...
  print('images.shape[] batch :', images.shape[0])
  print('images.shape[] in_hg :', images.shape[1])
  print('images.shape[] in_wd :', images.shape[2])
  print('images.shape[] in_ch :', images.shape[3])
...
def main(argv=None):  # pylint: disable=unused-argument
  ...
  with tf.Graph().as_default():
    ...
    # ToDo: yomero
    #images = tf.to_float(X_train, name='ToFloat')
    #labels = tf.to_float(y_train, name='ToFloat')
    images = X_train
    labels = y_train

    # Build a Graph that computes the logits predictions from the
    # inference model.
    logits = prediction_model(images)
