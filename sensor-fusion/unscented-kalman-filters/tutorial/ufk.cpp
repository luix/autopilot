 ...
 ******************************************************************************/
  ...
  double lambda_sqrt = sqrt(lambda + n_x);

  for ( int i = 0 ; i < n_x ; i++ )
  {
      Xsig.col(i + 1) = x + lambda_sqrt * A.col(i);
      Xsig.col(i + 1 + n_x) = x - lambda_sqrt * A.col(i);
  }
 ...
 ******************************************************************************/
  ...
  double lambda_sqrt = sqrt(lambda + n_aug);

  for ( int i = 0; i < n_aug ; i++ )
  {
    Xsig_aug.col(i + 1) = x_aug + lambda_sqrt * A_aug.col(i);
    Xsig_aug.col(i + n_aug + 1) = x_aug - lambda_sqrt * A_aug.col(i);
  }
 ...
 ******************************************************************************/
  ...
  // 2n+1 simga points
  int simga_points_size = 2 * n_aug + 1;

  // transform sigma points into measurement space
  for ( int i = 0 ; i < simga_points_size ; i++ )
  {
 ...
 ******************************************************************************/
  ...
  // 2n+1 simga points
  const int sigma_points_size = 2 * n_aug + 1;
